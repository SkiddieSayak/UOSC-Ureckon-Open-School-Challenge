...
<head>
    ...
    <title>Ureckon Open School Challenge | Contact</title>
...
<body>
    ...
    <div class="contact-container">
        ...
        <div class="contact-card">
            <div class="cc-container nmp">
                <div class="nmp cc-pic">
                    <img src="{{asset('assets/img/contacts/Kainat.jpg')}}" alt="" class="contact-img">
        ...
        <div class="contact-card">
            <div class="cc-container nmp">
                <div class="nmp cc-pic">
                    <img src="{{asset('assets/img/contacts/Srijani.jpg')}}" alt="" class="contact-img">
